...
function ShipperOrderDetailsView({ orderDetails }) {
      ...
      <div className="grid gap-6">
        <div className="grid gap-2">
          <div className="flex mt-6 gap-40 items-center justify-between">
            <p className="font-medium min-w-[100px]">Order ID</p>
              ...
              {orderDetails?.cartItems && orderDetails?.cartItems.length > 0
                ? orderDetails?.cartItems.map((item) => (
                    <li className="flex items-center justify-between">
                      ...
                      <span>Price: {item.price.toLocaleString()}đ</span>
                    </li>
                  ))
                : null}
            </ul>
...
export default ShipperOrderDetailsView;